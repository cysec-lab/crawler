...
def del_falsification_RAD(org_path: str):
    """
    RADに自作改ざんサイトの結果が残っていると
    それを含めたデータが作成されてしまう(次回以降のクローリングに影響が出てしまう)ため、削除する
    """
...
def copy_ROD_from_cysec(org_path: str):
    """
    ...
    if os.path.exists(src_path):
        ...
        falsification_tag_dict: Dict[str, Any] = dict()
    ...
    if os.path.exists(src_path):
        ...
        falsification_hash_dict: Dict[str, Any] = dict()
