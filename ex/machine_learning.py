...
# kaizan_list: list[dict[str, Union[int, str]]] = list()
...
# def check_tags(host: str, url: str, src: str, tags, server_without_iframe_set, cannot_make_vec_server_set, tree_dict, sample):
#     # iframeタグがない場合
...
# def machine_learning_main(recvq: Queue[str], sendq, path: str):
